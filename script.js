...
const app = {
    ...
    data: {
        apps: [
            { id: 'telefone', name: 'Telefone', icon: 'call', color: '#22c55e', desc: 'Fazer ligações', oldTech: 'Telefone fixo antigo' },
            ...
            { id: 'mensagens', name: 'Mensagens', icon: 'chat', color: '#3b82f6', desc: 'Enviar textos', oldTech: 'Telegramas' },
